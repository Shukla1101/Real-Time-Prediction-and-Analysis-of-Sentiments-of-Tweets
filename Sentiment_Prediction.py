...
with open("/Users/rahulshukla/Desktop/Projects and coding/Projects/sentiment analysis/Tweet_Dats.csv", 'w') as f:
                    writer = csv.writer(f)
                    writer.writerow([
                        "date:","pos","neg","neu"
                    ])    
with open("/Users/rahulshukla/Desktop/Projects and coding/Projects/sentiment analysis/Tweet_Dats.csv", 'a') as f:
                    writer = csv.writer(f)
                    writer.writerow([
...
def anl_tweets(lst, title='Tweets Sentiment', engl=True ):
    ...
    series = read_csv('/Users/rahulshukla/Desktop/Projects and coding/Projects/sentiment analysis/Tweet_Dats.csv', header=0, index_col=0, parse_dates=True, squeeze=True) 
...
OptionList=[]
data=[]
datafile = open('/Users/rahulshukla/Desktop/Projects and coding/Projects/sentiment analysis/Tweet_Dats.csv', 'r')
